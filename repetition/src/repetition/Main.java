...
public class Main {
	...
	public static void main(String[] args) {
		 Person alina = new Person("Alina", "ali@gmail.com", LocalDate.of(2014, 03, 9));
		 ...
		 Person helga = new Person("Helga", "hel@gmail.com", LocalDate.of(1932, 07, 23));
		 Person jørgen = new Person("Jørgen","jor@gmail.com", LocalDate.of(1935, 06, 30));
		 ...
		 ArrayList<Person> familie = new ArrayList<Person>();
		  ...
		  //  System.out.println("Listen indeholder følgende 10 familiemedlemmer:" + familie);
